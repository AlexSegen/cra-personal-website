...
const SkillItem = ({ name, logo }) => {
    ...
    return (
        <div className={styles.sk__item + " wow fadeInUp"}>
            <img className={styles.sk__item_icon} src={'/img/tech/' + logo} alt={name}/>
            <span className={styles.sk__item_name}>{name}</span>
        </div>
    )
}
...
const About = () => {
    ...
    return ( 
        <Layout title="Acerca de mí" description="Soy Desarrollador Frontend / Diseñador Web desde hace más de 6 años.">
